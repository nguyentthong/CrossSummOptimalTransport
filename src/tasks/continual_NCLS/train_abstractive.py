...
import src.tasks.continual_NCLS.distributed as distributed
from src.continual_NCLS.models import data_loader, model_builder
from src.continual_NCLS.models.data_loader import load_dataset
from src.continual_NCLS.models.loss import abs_loss
from src.continual_NCLS.models.model_builder import AbsSummarizer
from src.continual_NCLS.models.predictor import build_predictor
from src.continual_NCLS.models.trainer import build_trainer
from src.continual_NCLS.others.logging import logger, init_logger
...
def test_abs(args, device_id, pt, step):
    ...
    if args.bart:
        ...
        tokenizer = BertTokenizer.from_pretrained('./snap/bert-base-multilingual-uncased', do_lower_case=True,
